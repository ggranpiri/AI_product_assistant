...
from AI_product_assistant.parser.parse_bd import get_categories, get_total_pages, parse_product_from_vv


class TestGetCategories(unittest.TestCase):

    @patch('AI_product_assistant.parser.parse_bd.requests.get')  # Патчим requests.get
    @patch('AI_product_assistant.parser.parse_bd.BeautifulSoup')  # Патчим BeautifulSoup
...
class TestParseProductFromVV(unittest.TestCase):
    @patch("AI_product_assistant.parser.parse_bd.parse_products_in_category")
    @patch("AI_product_assistant.parser.parse_bd.get_categories")
